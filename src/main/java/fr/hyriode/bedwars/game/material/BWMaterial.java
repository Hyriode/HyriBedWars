...
public enum BWMaterial{
    ...
    SHEARS(BWShopCategory.TOOLS, "shears", new ItemBuilder(Material.SHEARS).unbreakable().withAllItemFlags().build(), true, new OreStack(BWGameOre.IRON, 20)),
    ...
    BEDBUG(BWShopCategory.UTILITY, "bedbug", new ItemBuilder(Material.SNOW_BALL).build(), new OreStack(BWGameOre.IRON, 30), BedBugBall.class),
