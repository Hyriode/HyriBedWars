...
public enum EBWUpgrades {
    ...
    SHARPNESS(new BWUpgrade("sharpness", new BWUpgradeTier(0, "sharpness", new ItemStack(Material.IRON_SWORD), new OreStack(BWGameOre.DIAMOND, 4)))),
    ...
    HEAL_POOL(new BWUpgrade("heal_pool", new BWUpgradeTier(0, "heal_pool", new ItemStack(Material.BEACON), new OreStack(BWGameOre.DIAMOND, 1)))),
    DRAGON(new BWUpgrade("dragon_buff", new BWUpgradeTier(0, "dragon_buff", new ItemStack(Material.DRAGON_EGG), new OreStack(BWGameOre.DIAMOND, 5)))),
    ;
    ...
    public BWUpgrade getUpgrade() {
        return upgrade.setEUpgrades(this);
    }
}
